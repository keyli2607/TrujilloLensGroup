  ...
  return (
    <section className="section" id="testimonios">
      <div className="container">
        ...
        {/* Botón a Google Maps Oficial */}
        <div className="google-cta-container">
          <a
            href="https://maps.app.goo.gl/xGcnJzLPnmXBZScR8"
            target="_blank"
            rel="noopener noreferrer"
          ...
          >
            ...
            <span>Ver perfil y dejar tu opinión en Google Maps</span>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ marginLeft: "0.2rem" }}>
